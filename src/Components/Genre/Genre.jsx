        ...
        <div style={cards}>
          {
            genreAction.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Action" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
                </div>
              </p>
            )
          }
        ...
        <div style={cards}>
          {
            genreThriller.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Horreur" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreRomance.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Romance" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreAdventure.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Adventure" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreAnimation.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Animation" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreComedy.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Comedy" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreCrime.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Crime" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreDocumentary.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Documentaire" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreDrama.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Drama" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreFamily.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Famille" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreFantasy.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Fantaisie" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreHistory.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Histoire" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreMusic.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Musique" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreMystery.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Mystere" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreScienceFiction.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="ScienceFiction" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreTVMovie.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="TvMovie" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreGuerre.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Guerre" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
        ...
        <div style={cards}>
          {
            genreWestern.map(genre =>
              <p style={card}>
                <img src={img + `${genre.poster_path}`} alt="Western" /><div>
                  Titre du film : {genre.original_title}
                </div>
                <div>
                  Date de Sortie : {genre.release_date}
